...
public class BankAccount {
  ...
  public BankAccount(String accountId, double initialBalance) {
    ...
    logger.info("Khởi tạo tài khoản. Tài khoản: {}. Số dư: {}", accountId, balance);
  }
  ...
  public void deposit(double amount) {
    ...
    balance += amount;
    logger.info("Nạp tiền thành công. Tài khoản: {}. Số dư mới: {}", accountId, balance);
  }
  ...
  public void withdraw(double amount) {
    ...
    if (amount > balance) {
      logger.error("Lỗi giao dịch: Số dư {} không đủ để rút {}", balance, amount);
         
      throw new IllegalArgumentException("Số dư không đủ");
    }
    balance -= amount;
    logger.info("Rút tiền thành công. Tài khoản: {}. Số dư mới: {}", accountId, balance);
  }
